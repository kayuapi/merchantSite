...
import { DineInOrder, DeliveryOrder, SelfPickupOrder } from '../types';
...
type OrderMemoProps = DineInOrder & DeliveryOrder & SelfPickupOrder;

const OrderMemo: FC<OrderMemoProps> = ({
  shopId,
  orderId,
  fulfillmentMethod,
  status,
